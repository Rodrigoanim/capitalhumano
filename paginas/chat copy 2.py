    ...
    try:
        ...
        system_prompts = {
            "resumo": """Gere um resumo conciso do conteúdo da transcrição.
                        Formate a resposta em parágrafos curtos e bem organizados.
                        Use marcadores quando apropriado.
                        Deixe espaço entre os parágrafos para melhor legibilidade.""",
            ...
            "analise": """Analise o conteúdo fornecendo:
                        ...
                        **Principais Insights:**
                        - Liste cada insight em uma nova linha
                        - Use linguagem clara e concisa
                        
                        **Pontos Contraintuitivos:**
                        - Liste cada ponto em uma nova linha
                        - Explique por que é contraintuitivo
                        
                        **Palavras-chave Relevantes:**
                        - Liste em tópicos
                        - Agrupe por categorias quando possível
                        
                        **Ferramentas ou Metodologias Mencionadas:**
                        - Nome da ferramenta/metodologia
                        - Breve descrição do uso/aplicação
                        
                        Formate a resposta com espaçamento adequado entre seções."""
        }
        ...
        print(f"# Debug - Conteúdo da resposta: {content[:100]}...")

        # Formatação adicional para melhor exibição no Streamlit
        if mode == "analise":
            # Garantir que cada seção principal comece com duas quebras de linha
            content = content.replace("**", "\n\n**")
            # Garantir que cada item de lista tenha uma quebra de linha
            content = content.replace("- ", "\n- ")
        elif mode == "resumo":
            # Adicionar quebras de linha entre parágrafos
            content = content.replace(". ", ".\n\n")
